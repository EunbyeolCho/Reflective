...
if __name__ == "__main__":
    ...
    # input_img_dir = "./images/a.jpg"
    gt_img_dir = r"./sample_images/a.jpg"
    ...
    while True:
        ...
        input_points, input_image = demo_web(input_image)
        ...
        count = 0
        csim_sum = 0
        input_image = cv2.resize(input_image, dsize=(350, 450))
